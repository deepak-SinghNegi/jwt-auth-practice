...
const Header = () => {
    return (
        <div className='w-full  flex flex-col justify-center items-center mt-20 px-4 text-gray-800 text-center'><img src={assets.header_img} alt="" className='w-50 h-50 rounded-full mb-6' />
            <h1 className='flex items-center gap-2 text-xl sm:text-3xl font-medium mb-2'>hey developer <img className="w-8 aspect-square" src={assets.hand_wave} alt="" className='w-8 aspect-square' />
            </h1>
